...
void* armean_harmean(void *param){
    thread_data *tdata=(thread_data *)param;
...
void* deviation_interquartile(void *param){
    thread_data *tdata=(thread_data *)param;
...
int main(int argc, char *argv[]) {
    ...
    pthread_t tid_4;
    pthread_t tid_5;
	pthread_create(&tid_1, NULL, min_max, (void *)&tdata);
    pthread_create(&tid_2, NULL, range_mode, (void *)&tdata);
    pthread_create(&tid_3, NULL, median_sum, (void *)&tdata);
    pthread_create(&tid_4, NULL, armean_harmean, (void *)&tdata);
    pthread_create(&tid_5, NULL, deviation_interquartile, (void *)&tdata);
